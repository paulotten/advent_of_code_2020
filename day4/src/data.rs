...
pub type Passport = HashMap<&'static str, &'static str>;

pub fn get_passports() -> Vec<Passport> {
    let data = "iyr:2015 cid:189 ecl:oth byr:1947 hcl:#6c4ab1 eyr:2026
hgt:174cm
pid:526744288
...
pid:453480077 eyr:2025 hcl:#a97842";
    ...
    let mut current_passport: Passport = HashMap::new();

    for line in data.lines() {
        // blank line is end of current passport record
        if line.len() == 0 {
        ...
        for entry in line.split(' ') {
            ...
            current_passport.insert(parts[0], parts[1]);
        }
    }

    // add last passport record
    passports.push(current_passport);
